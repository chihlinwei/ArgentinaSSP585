library(raster)
epc <- brick("F:/CMIP6_Argentina/Raster/epcBottom/epcBottom_avg_ssp126.grd")
o2 <- brick("F:/CMIP6_Argentina/Raster/o2Bottom/o2Bottom_avg_ssp126.grd")
ph <- brick("F:/CMIP6_Argentina/Raster/phBottom/phBottom_avg_ssp126.grd")
thetao <- brick("F:/CMIP6_Argentina/Raster/thetaoBottom/thetaoBottom_avg_ssp126.grd")
arag <- brick("F:/CMIP6_Argentina/Raster/aragBottom/aragBottom_avg_ssp126.grd")
calc <- brick("F:/CMIP6_Argentina/Raster/calcBottom/calcBottom_avg_ssp126.grd")
co3 <- brick("F:/CMIP6_Argentina/Raster/co3Bottom/co3Bottom_avg_ssp126.grd")
co3satarag <- brick("F:/CMIP6_Argentina/Raster/co3sataragBottom/co3sataragBottom_avg_ssp126.grd")
co3satcalc <- brick("F:/CMIP6_Argentina/Raster/co3satcalcBottom/co3satcalcBottom_avg_ssp126.grd")
aragsat <- brick("F:/CMIP6_Argentina/Raster/aragsatBottom/aragsatBottom_avg_ssp126.grd")
calcsat <- brick("F:/CMIP6_Argentina/Raster/calcsatBottom/calcsatBottom_avg_ssp126.grd")
